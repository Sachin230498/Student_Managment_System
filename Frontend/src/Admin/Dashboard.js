...
// const Dashboard = () => {
//   const studentsCount = '15k';
//   const instructorsCount = '2000+';
//   const coursesCount = '100+';
...
//                 <div className="flex flex-col flex-grow">
//                   <h3 className="text-xl font-semibold">Instructor</h3>
//                   <p className="text-2xl">{instructorsCount}</p>
//                 </div>
//                 <div className="flex items-center">
//                   <GrUserWorker style={{ fontSize: '2rem' }} />
//                 </div>
...
//                   <option>Section</option>
//                 </select>
//                 <button className="w-full p-2 bg-blue-300 text-black rounded shadow-md hover:bg-indigo-200">
