...
//             </select>
//             <button className="w-full p-2 bg-blue-500 text-white rounded">Download routine (pdf)</button>
//           </div>
//         </div>
...
//           <div className="flex justify-center items-center h-32 bg-gray-200 rounded">Pie chart here</div>
//         </div>
...
// const Dashboard = () => {
//   const totalCourses = 15000;
//   const maxCourses = 20000; 
