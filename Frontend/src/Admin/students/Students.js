...
//     try {
//       const response = await fetch('http://localhost:8081/api/getstudent');
//       if (!response.ok) {
...
export default function Students() {
  ...
  const handlePromote = async (id) => {
    try {
      console.log('Promoting student with ID:', id);
      ...
      console.log('Student promoted:', updatedStudent);
  ...
  const handleSetPaidStatus = async (id) => {
    try {
      ...
      const updatedStudent = await response.json();
      console.log('Student set to paid:', updatedStudent);
      fetchStudents(); // Re-fetch the students to update the list
                  ...
                  <tr key={index} className={index % 2 === 0 ? "bg-gray-100" : "bg-white"}>
                    ...
                    <td className="py-2 px-4 border-b">
                      ...
                      <button
                        ...
                        className="bg-red-300 text-black px-4 py-2 rounded-lg shadow-md hover:bg-red-100 transition duration-300 ease-out hover:ease-in"
                      >
                        Delete
                      </button>
