...
//   return (
//     <>
//     {/* <div className='flex flex-col justify-center items-center  p-3 mt-2' style={{ backgroundImage:`url(${full})` , backgroundRepeat:"no-repeat", backgroundSize:"cover", width:"100%", height: "400px" }} > */}
...
//       </video>
//      <div className='flex flex-col justify-center items-center gap-2 mt-1 mb-6'>
//       <p className='sm:text-4xl text-2xl font-bold mb-6'>Become a Full Stack Web Developer </p>
...
//       <h1 className='sm:text-4xl text-2xl font-bold'>for full stack web development Program</h1>
    ...
    <>
      <div className='relative flex flex-col justify-center items-center p-3 mt-2' style={{ height: "400px", width: "100%" }}>
        ...
        <div className='relative z-10 text-black text-center'>
          <h1 className='sm:text-5xl text-3xl font-bold mb-6'>Become a Full Stack Web Developer</h1>
